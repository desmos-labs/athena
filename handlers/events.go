...
func FindEventByType(tx jtypes.Tx, index int, eventType string) (sdk.StringEvent, error) {
...
func FindAttributeByKey(tx jtypes.Tx, event sdk.StringEvent, attrKey string) (string, error) {
